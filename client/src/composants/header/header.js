...
function Header (){
    ...
    const venderRoute = () =>{
        return (
            <>
                <li><Link to = "/create_prodV">Ajout Produit</Link></li>
                <li><Link to = "/categoryV">Categories</Link></li>
            </>
        )    
    }
    ...
    const adminRoute = () =>{
        return (
            <>
                <li><Link to = "/create_prod">Ajout Produit</Link></li>
    ...
    const clientRoute = () =>{
        return (
            <>
            <li><Link to = "/history">Commande</Link></li>
            <li><Link to = "/" onClick = {logoutClient}>Deconnexion</Link></li>
        </>
        )    
    }
